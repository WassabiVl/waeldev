    ...
    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
      <q-card class="q-ma-xs" style="background-color: #38b1c5">
        ...
        <q-card-section class="q-pa-none">
          <div id="linechart" ref="linechart" style="height: 250px;"></div>
        </q-card-section>
      </q-card>
    </div>
    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
      <q-card class="q-ma-xs" style="background-color: #ea4b64">
        ...
        <q-card-section class="q-pa-none">
          <div id="barchart" ref="barchart" style="height: 250px;"></div>
        </q-card-section>
      </q-card>
    </div>
    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
      <q-card class="q-ma-xs" style="background-color: #1e88e5">
        ...
        <q-card-section class="q-pa-none">
          <div id="linechart2" ref="linechart2" style="height: 250px;"></div>
        </q-card-section>
      </q-card>
    </div>
