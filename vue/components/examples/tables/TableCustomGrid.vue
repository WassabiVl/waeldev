<template>
  <q-card>
    ...
    <q-card-section class="q-pa-none">
      <q-table :columns="columns" :rows="data" grid hide-bottom>
        <template v-slot:item="props">
          <div class="q-pa-xs col-xs-12 col-sm-6 col-md-4 col-lg-3">
            <card-profile :avatar="props.row.avatar" :des="props.row.des" :name="props.row.name"></card-profile>
          </div>
        </template>
      </q-table>
    </q-card-section>
...
import CardProfile from '../../../components/examples/cards/CardProfile';
